...
;;; Converted to the Common LISP in order to be used as an educational
;;; tool by Antti J Ylikoski, 01-07-2011.

;;; This file originally stems from Djame Seddah
;;; (djame.seddah@paris-sorbonne.fr)  Merci beaucoup!!!!


;;; The only sensible thing to do with any size of a program is to put
;;; it in its own package, to avoid a hyperzillion name conflicts.
;;; Antti J Ylikoski 01-07-2011.



(defpackage :mini-prolog
  (:use :common-lisp))


(in-package :mini-prolog)
...
(defun rename-variables (term list-of-level)
       ...
       (cond ((variable-p term) (append (list term) list-of-level))
...
(defun print-bindings (environment-left environment)
       ...
       (cond ((cdr environment-left)
              ...
              (cond ((=3D 0 (nth 2 (caar environment-left)))
